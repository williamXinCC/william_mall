	...
	<view class="userinfo">
      ...
      <!--#ifdef H5-->
			...
			<view class="portrait-box" @tap="uploadImage">
				<image class="portrait" :src="profileInfo.customerIcon || headImg"></image>
			</view>
      <!-- #endif -->
			<!--#ifndef H5-->
			<!--非h5裁剪头像上传-->
        ...
        <avatar
					canRotate="false"
          selWidth="200px" selHeight="400upx" @upload="handleUploadFile" :avatarSrc="profileInfo.customerIcon || headImg"
      ...
      <!-- #endif -->
		...
		<view class="input-content">
				<view class="input-item">
					...
					<input
						type="number"
						v-model="profileInfo.customerPhone"
						disabled
						placeholder="请输入手机号码"
					/>
				</view>
				...
				<view class="input-item">
					...
					<input
						type="text"
						v-model="profileInfo.customerName"
						placeholder="请输入您的姓名"
					/>
				</view>
				<view class="input-item">
					...
					<radio-group @change="handleGenderChange">
						<label class="gender-item" v-for="(item, index) in genders" :key="index">
							<radio class="gender-item-radio" color="#fa436a" :value="item.value" :checked="item.value == profileInfo.customerGender" />
				...
				<view class="input-item">
					...
					<input
						v-model="profileInfo.customerEmail"
						placeholder="请输入您的邮箱"
					/>
				</view>
